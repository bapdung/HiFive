    ...
    <div className="overflow-hidden h-full">
      <div className=" pb-[100vh] w-56 h-full bg-white pt-10 absolute left-0 shadow-side-shadow p-2.5">
        ...
        >
          ...
          <span className="text-h6">나의 활동</span>
        </Link>
        <Link
          to="/mypage/my-info"
        ...
        >
          ...
          <span className="text-h6">내 정보 수정</span>
        </Link>
        <Link
          to="/mypage/gallery"
        ...
        >
          ...
          <span className="text-h6">추억 갤러리</span>
        </Link>
        <Link
          to="/mypage/idcard"
        ...
        >
          ...
          <span className="text-h6">신분증 등록</span>
        </Link>
        <Link
          to="/mypage/point"
        ...
        >
          ...
          <span className="text-h6">포인트 관리</span>
        </Link>
      </div>
    </div>
  );

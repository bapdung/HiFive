...
public class FanmeetingController {
	...
	@GetMapping(path = "/scheduled/creator/{creatorId}", produces = MediaType.APPLICATION_JSON_VALUE)
	...
	@GetMapping(path = "/completed/creator/{creatorId}", produces = MediaType.APPLICATION_JSON_VALUE)
	...
	public ResponseEntity<List<FanmeetingOverViewDto>> getScheduledFanmeetingForFan(@AuthenticationPrincipal Member member) {
		List<FanmeetingOverViewDto> fanmeetings = fanmeetingService.getScheduledFanmeetingForFan(member);
	...
	public ResponseEntity<List<FanmeetingOverViewDto>> getCompletedFanmeetingForFan(@AuthenticationPrincipal Member member) {
		List<FanmeetingOverViewDto> fanmeetings = fanmeetingService.getCompletedFanmeetingForFan(member);
		return ResponseEntity.ok(fanmeetings);
	}

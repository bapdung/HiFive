...
public class CommentService {
	...
	public List<CommentResponseDto> getCommentAll(long boardId, CommentParam param) {
		Board board = boardRepository.findById(boardId)
			.orElseThrow(() -> new DataNotFoundException(ErrorCode.BOARD_NOT_FOUND));

		return commentRepository.getCommentAllByBoardAndTopId(board.getBoardId(), param.getTop()).stream()
